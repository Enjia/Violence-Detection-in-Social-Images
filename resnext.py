...
model_urls = {
      ...
      'ResNext50_best': 'http://data.lip6.fr/cadene/pretrainedmodels/checkpoint_SDPResNext50.pth.tar',}
...
def resnext50(pretrained=False, **kwargs):
  ...
  if pretrained:
      state_dict = model_zoo.load_url(model_urls['ResNext50_best'], model_dir='/search/odin/Enjia/code/')
...
def resnext101(pretrained=False, **kwargs):
  ...
  if pretrained:
      ...
      state_dict = model_zoo.load_url(model_urls['resnext101_64x4d'], model_dir='/search/odin/Enjia/code/')
      for key in list(state_dict.keys()):
          ...
          #model.load_state_dict(model_zoo.load_url(model_urls['resnext101_64x4d'], model_dir='/search/odin/Enjia/code/'))
  return model